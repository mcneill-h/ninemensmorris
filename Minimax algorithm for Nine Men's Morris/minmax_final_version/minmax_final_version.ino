...
int bot[9] = { 0, 2, -2, -2, -2, -2, -2, -2, -2 };  //{ -2, 17, 27, 1, 11, -2, -2, -2, -2 }
int taille_liste_bot = 0;                             //donne le nombre d'éléments dans la liste bot

int player[9] = { 3, 15, -2, -2, -2, -2, -2, -2, -2 };  //{ 3, 2, 14, 15, -2, -2, -2, -2, -2 }
...
void move_bot() {  ////////////////////////////////////////////MOVE//////////////////////////////////////////////
  ...
  if (breaking_news == true) {   // le tour où on a actualisé le move du joueur
    if (in_beginning == true) {  //en debut de jeu qd les joueurs place les pieces
      ...
      //score final
      Serial.println("According to the program, the most optimal move is:");
      Serial.println(bot[move_optimal_case_depart]);
      Serial.println("-->");
      Serial.println(move_optimal_case_arrive);


      Serial.println("position of the deleted piece:");
